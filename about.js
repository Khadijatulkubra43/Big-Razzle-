        ...
        document.querySelectorAll('a, button, .team-card, .mv-card, .different-card, .value-card').forEach(el => {
        ...
        document.querySelectorAll('.team-card, .mv-card, .different-card, .value-card').forEach(card => {
            ...
            card.addEventListener('mouseleave', function() {
                ...
                if (this.classList.contains('team-card')) {
        ...
        document.querySelectorAll('.mv-card, .different-card, .team-card, .value-card').forEach(el => {
            el.style.opacity = '0';
