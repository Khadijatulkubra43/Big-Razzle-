        ...
        document.querySelectorAll('a, button, .service-card, .benefit-card').forEach(el => {
        ...
        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    // Add special animation for process steps
        ...
        document.querySelectorAll('.service-card, .benefit-card, .process-step').forEach(el => {
            ...
            if (el.classList.contains('process-step')) {
                el.querySelector('.step-number').style.transform = 'scale(0.8)';
                el.querySelector('.step-number').style.opacity = '0.7';
                el.querySelector('.step-number').style.transition = 'transform 0.6s ease, opacity 0.6s ease';
            }
